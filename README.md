# 🐺 Werewolf GM (Maître du Jeu Loups-Garous)

Une application web interactive conçue pour assister le Maître du Jeu (MJ) lors des parties de Loups-Garous de Thiercelieux. Fini le papier et le crayon, l'application gère les rôles, les tours et les morts automatiquement, le tout avec une interface optimisée pour mobile !
...
Aucune installation complexe n'est requise. C'est du pur HTML, CSS et Vanilla JavaScript.

1.  Clonez ce dépôt ou téléchargez les fichiers.
2.  Ouvrez le fichier `index.html` dans votre navigateur web.
3.  Pour la meilleure expérience en soirée, hébergez le code sur **GitHub Pages** et ajoutez le lien à l'écran d'accueil de votre smartphone.
